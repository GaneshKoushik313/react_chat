...
function (e) {
    e("document").ready(function () {
        e("input.form-control, textarea.form-control").fuseMdInput(), e(".btn-toolbar .btn-group .btn:not(.dropdown-toggle), .radio-icon, .checkbox-icon, .custom-control-indicator, .pagination .page-link, .btn-icon, .btn-fab, .ripple-centered, .ripple-center").fuseRipple({
            fromCenter: !0
        }), e(".ripple, .btn:not(.no-ripple), .radio-icon, .checkbox-icon, .custom-control-indicator, .pagination .page-link, .dropdown-item").fuseRipple(), e(window).on("fuse::barInit fuse::barClosed fuse::asideFolded fuse::asideUnfolded", function (e, n) {
